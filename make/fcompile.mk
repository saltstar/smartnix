...
MODULE_FIDL_FILE_LIST := $(MODULE_GENDIR)/fidl-files
...
$(MODULE_FIDL_COBJS): MODULE_COMPILEFLAGS:=$(MODULE_COMPILEFLAGS) -fvisibility=hidden -Isystem/ulib/fidl/include $(foreach dep,$(MODULE_FIDL_DEPS),-I$(call TOBUILDIR,$(dep))/gen/include) -I$(MODULE_FIDL_INCLUDE)
...
$(MODULE_FIDL_CPPOBJS): MODULE_COMPILEFLAGS:=$(MODULE_COMPILEFLAGS) -fvisibility=hidden -Isystem/ulib/fidl/include $(foreach dep,$(MODULE_FIDL_DEPS),-I$(call TOBUILDIR,$(dep))/gen/include) -I$(MODULE_FIDL_INCLUDE)
...
$(MODULE_FIDL_FILE_LIST): FIDL_SRCS:=$(MODULE_FIDLSRCS)
$(MODULE_FIDL_FILE_LIST):
	@$(MKDIR)
	$(NOECHO)echo $(FIDL_SRCS) > $@
...
$(MODULE_FIDL_RSP): $(foreach dep,$(MODULE_FIDL_DEPS),$(call TOBUILDDIR,$(dep))/gen/fidl-files) $(MODULE_FIDLSRCS) make/fcompile.mk
	@$(MKDIR)
	$(NOECHO)echo --name $(FIDL_NAME) --c-header $(FIDL_H) --c-client $(FIDL_CLIENT_C) --c-server $(FIDL_SERVER_C) --tables $(FIDL_CPP) $(foreach dep,$(FIDL_DEPS),--files $(shell cat $(call TOBUILDDIR,$(dep))/gen/fidl-files)) --files $(FIDL_SRCS) > $@
