...
#define TRACE_VTHREAD_DURATION_BEGIN(category_literal, name_literal,          \
                                     vthread_literal, vthread_id, args...)    \
    TRACE_INTERNAL_VTHREAD_DURATION_BEGIN((category_literal), (name_literal), \
                                          (vthread_literal), (vthread_id), args)
...
#define TRACE_VTHREAD_DURATION_END(category_literal, name_literal,          \
                                   vthread_literal, vthread_id, args...)    \
    TRACE_INTERNAL_VTHREAD_DURATION_END((category_literal), (name_literal), \
                                        (vthread_literal), (vthread_id), args)
...
#define TRACE_VTHREAD_FLOW_BEGIN(category_literal, name_literal,          \
                                 ...
                                 args...)                                 \
    TRACE_INTERNAL_VTHREAD_FLOW_BEGIN((category_literal), (name_literal), \
...
#define TRACE_VTHREAD_FLOW_STEP(category_literal, name_literal,          \
                                vthread_literal, vthread_id, flow_id,    \
                                args...)                                 \
    TRACE_INTERNAL_VTHREAD_FLOW_STEP((category_literal), (name_literal), \
                                     (vthread_literal), (vthread_id),    \
                                     (flow_id), args)
...
#define TRACE_VTHREAD_FLOW_END(category_literal, name_literal,          \
                               vthread_literal, vthread_id, flow_id,    \
                               args...)                                 \
    TRACE_INTERNAL_VTHREAD_FLOW_END((category_literal), (name_literal), \
                                    (vthread_literal), (vthread_id),    \
                                    (flow_id), args)
