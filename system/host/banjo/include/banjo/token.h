...
#ifndef ZIRCON_SYSTEM_HOST_BANJO_INCLUDE_BANJO_TOKEN_H_
#define ZIRCON_SYSTEM_HOST_BANJO_INCLUDE_BANJO_TOKEN_H_
...
#endif // ZIRCON_SYSTEM_HOST_BANJO_INCLUDE_BANJO_TOKEN_H_
