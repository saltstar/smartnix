...
#ifndef ZIRCON_SYSTEM_HOST_BANJO_INCLUDE_BANJO_TABLES_GENERATOR_H_
#define ZIRCON_SYSTEM_HOST_BANJO_INCLUDE_BANJO_TABLES_GENERATOR_H_
...
#endif // ZIRCON_SYSTEM_HOST_BANJO_INCLUDE_BANJO_TABLES_GENERATOR_H_
