...
// pretty much exactly corresponding to the grammar of a single banjo
...
// here, like everywhere in the banjo compiler, are backed by a string
...
#endif // ZIRCON_SYSTEM_HOST_BANJO_INCLUDE_BANJO_RAW_AST_H_
