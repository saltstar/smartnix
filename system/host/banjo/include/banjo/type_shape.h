...
#ifndef ZIRCON_SYSTEM_HOST_BANJO_INCLUDE_BANJO_TYPE_SHAPE_H_
#define ZIRCON_SYSTEM_HOST_BANJO_INCLUDE_BANJO_TYPE_SHAPE_H_
...
#endif // ZIRCON_SYSTEM_HOST_BANJO_INCLUDE_BANJO_TYPE_SHAPE_H_
