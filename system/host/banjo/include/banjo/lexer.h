...
#ifndef ZIRCON_SYSTEM_HOST_BANJO_INCLUDE_BANJO_LEXER_H_
#define ZIRCON_SYSTEM_HOST_BANJO_INCLUDE_BANJO_LEXER_H_
...
#endif // ZIRCON_SYSTEM_HOST_BANJO_INCLUDE_BANJO_LEXER_H_
